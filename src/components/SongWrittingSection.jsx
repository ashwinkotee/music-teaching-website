  ...
  return (
    <section className="p-8 md:p-16 flex flex-col md:flex-row items-start justify-between bg-gray-100">
      ...
      <div className="md:w-1/2 md:pr-8">
        ...
        <p className="mb-4">
          Whether you're a complete beginner or a seasoned musician, songwriting
          is about discovering your voice — and giving it shape, structure, and
          emotion.
        </p>
        ...
        <p className="mb-6">
          ...
          and live performance — drawing from my real-world experience composing
          for film and releasing original tracks.
        </p>
