  ...
  return (
    <section className="p-8 md:p-16 flex flex-col md:flex-row items-center justify-between bg-gray-100">
      <div className="md:w-1/2 mb-8 md:mb-0 ">
        {/* //className="rounded-lg shadow-lg object-cover h-[400px] md:h-[480px] w-full" */}
        <img src="/withArr.jpg" alt="Conference" className=" shadow-md" />
      </div>
      ...
      <div className="md:w-1/2 md:pl-12">
        ...
        <div className="space-y-4 mb-6">
          ...
          <p>
            Today, I bring that same passion into every session — whether it’s a
            one-on-one lesson, a composition project, or a live performance.
