    ...
    <section className="bg-white dark:bg-gray-900 py-16 px-6 md:px-16 text-gray-900 dark:text-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Songwriting Lessons</h1>
          <p className="text-lg md:text-xl">Turn your thoughts into lyrics, melodies, and meaning — and bring your music to life.</p>
          <img src="/song-writting.jpg" alt="Songwriting session with piano and notebook" width={800} height={400} className="rounded-lg mx-auto mt-6 shadow-lg" />
        </div>
        ...
        <div className="mb-12">
          ...
          <p className="mb-4">
            You'll also gain insight into how songs are created for albums, movies, and live performances — drawing from my real-world experience composing for film and releasing original tracks.
          </p>
          <p className="mb-4">
        ...
        {/* Details & Pricing */}
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-6">Lesson Format & Pricing</h2>
          <ul className="list-disc list-inside space-y-2">
            <li><strong>Format:</strong> 1-on-1 private coaching</li>
        ...
        <div className="text-center">
          <p className="mb-4 text-lg">Let’s write your next song — together.</p>
